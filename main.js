...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = (0, _redux.createStore)(_reducers2.default, {}, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, _api2.default),
	...
	exports.default = function (store) {
	  return function (next) {
	    return function (action) {
	      ...
	      var rest = _objectWithoutProperties(action, ['callAPI', 'type']);

	      if (!callAPI) return next(action);

	      next(_extends({
	        type: type + _constants.START
	      }, rest));

	      _jquery2.default.get(callAPI).done(function (response) {
	        return next(_extends({ type: type + _constants.SUCCESS, response: response }, rest));
	      }).fail(function (error) {
	        return next(_extends({ type: type + _constants.FAIL, error: error }, rest));
	      });
	    };
	  };
	};
...
/***/ function(module, exports) {
	...
	var LOAD_POKEMONS = exports.LOAD_POKEMONS = 'LOAD_POKEMONS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pokemons = __webpack_require__(194);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          { onClick: this.props.loadPokemons },
	          'Test!'
	        ),
	        pokemonList.map(function (pokemon) {
	          var imgUrl = 'http://pokeapi.co/media/img/' + pokemon.pkdx_id + '.png';
	          return _react2.default.createElement(
	            'div',
	            { key: pokemon.name },
	            _react2.default.createElement(
	...
	exports.default = (0, _reactRedux.connect)(function (state) {
	  ...
	  loadPokemons: _pokemons.loadPokemons
	})(Root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.loadPokemons = loadPokemons;

	var _constants = __webpack_require__(192);

	function loadPokemons() {
	  return {
	    type: _constants.LOAD_POKEMONS,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pokemons = __webpack_require__(196);
	...
	exports.default = (0, _redux.combineReducers)({
	  pokemonList: _pokemons2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case _constants.LOAD_POKEMONS + _constants.START:
	      console.log(action);
	      return state;
	    case _constants.LOAD_POKEMONS + _constants.SUCCESS:
	      console.log(action);
